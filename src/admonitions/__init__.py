...
class Admonition:
    ...
    def render(
        ...
        if isinstance(content, str):
            if markup:
                _content: Text | RenderableType = Text.from_markup(content, end="")
            else:
